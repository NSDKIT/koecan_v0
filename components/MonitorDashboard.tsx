...
const CHARACTER_MESSAGES: Record<ActiveTab, string[][]> = {
  ...
  career_consultation: [
    ...
    ['キャリアの悩みを', '一緒に考えよう'],
    ['シーエイトに', '相談してみよう'],
    ['キャリア支援のプロが', 'サポートしてくれるよ'],
    ['相談してみると', '解決策が見つかるかも'],
    ['キャリアの悩みは', '相談してみて'],
    ['シーエイトに相談すると', 'アドバイスがもらえる'],
    ['キャリア支援のプロが', '手助けしてくれる'],
    ['相談してみると', '道が開けるよ'],
    ['キャリアの悩みを', '一緒に解決しよう'],
    ['シーエイトに', '相談してみてね'],
    ...
    ['キャリア支援のプロが', '助けてくれる'],
    ['相談してみると', '解決策が見つかる'],
    ['キャリアの悩みは', '一人で抱え込まないでね'],
    ['シーエイトに', '相談してみよう'],
    ['キャリア支援のプロが', '手助けしてくれるよ'],
    ['相談してみると', '道が開けるかも'],
    ['キャリアの悩みを', '一緒に考えてみよう'],
    ['シーエイトに相談すると', 'アドバイスがもらえるよ']
  ],
  bulletin_board: [
    ['掲示板で', '最新情報をチェックしよう！'],
    ['新しいお知らせが', 'あるか確認してみて'],
    ...
    ['掲示板で重要な', '情報を見逃さないで'],
    ['新しいお知らせが', '追加されたか確認して'],
    ['掲示板で最新の', '情報をチェックしてみよう'],
    ['お知らせを見て', '最新情報をゲットしてみて'],
    ['掲示板で', '情報を確認しよう'],
    ['新しいお知らせが', 'あるかチェックしてね'],
    ['掲示板で', '最新情報を確認してみて'],
    ['お知らせをチェックして', '情報をゲット！'],
    ['掲示板で重要な', '情報を見逃さないでね'],
    ['新しいお知らせが', '追加されたか見てみよう'],
    ['掲示板で最新の', '情報をチェックして'],
    ['お知らせを見て', '最新情報をゲットしてみよう'],
    ['掲示板で', '情報を確認してみて'],
    ['新しいお知らせが', 'あるか確認してみよう'],
    ['掲示板で', '最新情報をチェックしてね'],
    ['お知らせを確認して', '情報をゲットしてみて'],
    ['掲示板で重要な', '情報を見逃さないで'],
    ['新しいお知らせが', '追加されたかチェックしよう']
  ]
};
